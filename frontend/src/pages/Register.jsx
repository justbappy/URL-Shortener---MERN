...
const Register = () => {
  return (
    ...
    >
        ...
        >
            <img src="images/Group.png" alt="register" 
            className='w-135'
            />
        </div>
        ...
        >        
            <div
            className='bg-white py-3 px-5 md:py-4 md:px-15 flex flex-col gap-3 w-[90%]'
            >
                ...
                <div>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <label htmlFor="" className='text-sm text-gray-700'>Username</label>
                        ...
                        >
                            ...
                            className='flex flex-col w-full'
                            >
                                <label htmlFor="" className='text-sm text-gray-700'>Confirm Password</label>
